...
// 	fmt.Println("\n\nStarting to encrypt tuples")

// 	for i := int64(0); i < pk.T.Int64(); i++ {
// 	  bgn.NewPlaintext(big.NewFloat(float64(i)), polyBase, pk.FPPrecision)
// 	  bgn.NewPlaintext(big.NewFloat(float64(i)), polyBase, pk.FPPrecision)
// 	}
// 	fmt.Println("\n\nDone encrypting tuples " + pk.T.String())
